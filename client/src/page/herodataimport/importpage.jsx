                        ...
                        <div className='HeroImportPageLeft'>
                            ...
                            <div className='HeroImportPageInitTalentPanel'>
                                ...
                                {initTalent && initTalent.map((IT, index) => {
                                    return(
                                        <div className='HeroImportPageInitTalent'
                                            key={index}
                                            onClick={() => {setCurrentInitTalent(IT); setOpenInitTalentForm(!openInitTalentForm); setInputPanelContent('InitTalent')}}
                                        >
                                            <div style={{
                                                flexBasis:'20%',
                                                display: 'flex',
                                ...
                                <div className='HeroImportPageInitTalentAddButton'
                                    onClick={() => {setCurrentInitTalent(null); setOpenInitTalentForm(!openInitTalentForm); setInputPanelContent('InitTalent')}}
                                >
                                    <AddIcon/>
                                </div>
                            </div>
